...
__all__ = ['ass6_resnet18', 'ass6_resnet34', 'ass6_resnet50', 'ass6_resnet101',
           'ass6_resnet152']
...
class AssConv(nn.Module):
    ...
    def forward(self, input):
        return self.ori_bn(self.ori_conv(input))+self.dilate_bn(self.dilate_conv(input))
...
def ass6_resnet18(num_classes=10):
    return ResNet(BasicBlock, [2,2,2,2],num_classes)

def ass6_resnet34(num_classes=10):
    return ResNet(BasicBlock, [3,4,6,3],num_classes)

def ass6_resnet50(num_classes=10):
    return ResNet(Bottleneck, [3,4,6,3],num_classes)

def ass6_resnet101(num_classes=10):
    return ResNet(Bottleneck, [3,4,23,3],num_classes)

def ass6_resnet152(num_classes=10):
    return ResNet(Bottleneck, [3,8,36,3],num_classes)


def demo():
    net = ass6_resnet18(num_classes=100)

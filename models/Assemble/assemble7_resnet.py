'''ResNet in PyTorch.
Assemble: conventional + alpha * dilate
...
__all__ = ['ass7_resnet18', 'ass7_resnet34', 'ass7_resnet50', 'ass7_resnet101',
           'ass7_resnet152']
...
def ass7_resnet18(num_classes=10):
    return ResNet(BasicBlock, [2,2,2,2],num_classes)

def ass7_resnet34(num_classes=10):
    return ResNet(BasicBlock, [3,4,6,3],num_classes)

def ass7_resnet50(num_classes=10):
    return ResNet(Bottleneck, [3,4,6,3],num_classes)

def ass7_resnet101(num_classes=10):
    return ResNet(Bottleneck, [3,4,23,3],num_classes)

def ass7_resnet152(num_classes=10):
    return ResNet(Bottleneck, [3,8,36,3],num_classes)


def demo():
    net = ass7_resnet18(num_classes=100)

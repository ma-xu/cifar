'''ResNet in PyTorch.
Assemble: conventional + sig(alpha(C_out)) * dilate
...
__all__ = ['ass9_resnet18', 'ass9_resnet34', 'ass9_resnet50', 'ass9_resnet101',
           'ass9_resnet152']
...
def ass9_resnet18(num_classes=10):
    return ResNet(BasicBlock, [2,2,2,2],num_classes)

def ass9_resnet34(num_classes=10):
    return ResNet(BasicBlock, [3,4,6,3],num_classes)

def ass9_resnet50(num_classes=10):
    return ResNet(Bottleneck, [3,4,6,3],num_classes)

def ass9_resnet101(num_classes=10):
    return ResNet(Bottleneck, [3,4,23,3],num_classes)

def ass9_resnet152(num_classes=10):
    return ResNet(Bottleneck, [3,8,36,3],num_classes)


def demo():
    net = ass9_resnet18(num_classes=100)

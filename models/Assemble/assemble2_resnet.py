'''ResNet in PyTorch.
Assemble: conventional + group[1,8,64]
...
__all__ = ['ass2_resnet18', 'ass2_resnet34', 'ass2_resnet50', 'ass2_resnet101',
           'ass2_resnet152']
...
def ass2_resnet18(num_classes=10):
    return ResNet(BasicBlock, [2,2,2,2],num_classes)

def ass2_resnet34(num_classes=10):
    return ResNet(BasicBlock, [3,4,6,3],num_classes)

def ass2_resnet50(num_classes=10):
    return ResNet(Bottleneck, [3,4,6,3],num_classes)

def ass2_resnet101(num_classes=10):
    return ResNet(Bottleneck, [3,4,23,3],num_classes)

def ass2_resnet152(num_classes=10):
    return ResNet(Bottleneck, [3,8,36,3],num_classes)


def demo():
    net = ass2_resnet18(num_classes=100)
